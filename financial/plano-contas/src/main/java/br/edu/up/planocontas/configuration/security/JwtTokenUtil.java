package br.edu.up.planocontas.configuration.security;
...
import br.edu.up.planocontas.domain.UserResponse;
import br.edu.up.planocontas.domain.ValidationResponse;
...
public class JwtTokenUtil {
    ...
    public ValidationResponse validateToken(String token) {
        try {
            ...
            // send POST request
            ResponseEntity<ValidationResponse> response = this.restTemplate.postForEntity(url, entity,
